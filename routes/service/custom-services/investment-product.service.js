...
router.get('/requirements/:id', function (req, res, next) {
    ...
    let query = `SELECT ID, operationId,roleId FROM investment_product_requirements WHERE status = 1 AND productId = ${req.params.id} AND 
                    ...
                    x.roleId.forEach((r, index2) => {
                        ...
                        axios.get(url, {
                            ...
                            .then(function (response2) {
                                ...
                                let badgeColor = (color[index2] !== undefined) ? color[index2] : color[rand];

...
router.get('/all', function (req, res, next) {
    ...
    let query = `SELECT ID,name,code,investment_max,investment_min FROM investment_products WHERE code LIKE "${search_string}%" OR name LIKE "${search_string}%" ORDER BY ID desc LIMIT ${limit} OFFSET ${page}`;

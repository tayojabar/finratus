            ...
            success: function (response) {
                ...
                if (preapproved_loan){
                    ...
                    $('#reason').html(`
                        ...
                        <p>6. Client is eligible for a loan of ₦${numberToCurrencyformatter(preapproved_loan.offer_loan_amount)} to be repaid over ${numberToCurrencyformatter(preapproved_loan.tenor)} month(s).</p>
                    `);
